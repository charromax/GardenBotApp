...
package com.example.gardenbotapp.ui.widgets;
...
public class CustomPercentageChartView extends View implements IPercentageChartView {
    ...
    public CustomPercentageChartView(Context context) {
        super(context);
        init(context, null);
    }

    public CustomPercentageChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomPercentageChartView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomPercentageChartView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     */
    public CustomPercentageChartView orientation(@ProgressOrientation int orientation) {
     ...
     */
    public CustomPercentageChartView startAngle(@FloatRange(from = 0f, to = 360f) float startAngle) {
     ...
     * @param enabled True if background have to be drawn, false otherwise.
     */
    public CustomPercentageChartView drawBackgroundEnabled(boolean enabled) {
     ...
     * @param color the color of the circular background
     */
    public CustomPercentageChartView backgroundColor(@ColorInt int color) {
     ...
     * @param color the color of the progress/progress bar
     */
    public CustomPercentageChartView progressColor(@ColorInt int color) {
     ...
     */
    public CustomPercentageChartView gradientColors(@GradientTypes int type, int[] colors, float[] positions, @FloatRange(from = 0f, to = 360f) float angle) {
     ...
     */
    public CustomPercentageChartView animationDuration(@IntRange(from = 50) int duration) {
        if (duration < 50) {
     ...
     */
    @SuppressWarnings("ConstantConditions")
    public CustomPercentageChartView animationInterpolator(@NonNull TimeInterpolator interpolator) {
     ...
     * @param color the text color
     */
    public CustomPercentageChartView textColor(@ColorInt int color) {
     ...
     */
    public CustomPercentageChartView textSize(float size) {
        if (size <= 0) {
     ...
     */
    @SuppressWarnings("ConstantConditions")
    public CustomPercentageChartView typeface(@NonNull Typeface typeface) {
        if (typeface == null) {
     ...
     */
    public CustomPercentageChartView textStyle(@TextStyle int style) {
        if (style < 0 || style > 3) {
     ...
     * @param shadowDistY  text shadow x-axis distance.
     */
    public CustomPercentageChartView textShadow(@ColorInt int shadowColor, @FloatRange(from = 0) float shadowRadius, @FloatRange(from = 0) float shadowDistX, @FloatRange(from = 0) float shadowDistY) {
     ...
     */
    public CustomPercentageChartView backgroundOffset(@IntRange(from = 0) int offset) {
        if (offset < 0) {
     ...
     */
    public CustomPercentageChartView drawBackgroundBarEnabled(boolean enabled) {
        try {
     ...
     */
    public CustomPercentageChartView backgroundBarColor(@ColorInt int color) {
        try {
     ...
     */
    public CustomPercentageChartView backgroundBarThickness(@FloatRange(from = 0) float thickness) {
        if (thickness < 0) {
     ...
     */
    public CustomPercentageChartView progressBarThickness(@FloatRange(from = 0) float thickness) {
        if (thickness < 0) {
     ...
     */
    public CustomPercentageChartView progressBarStyle(@ProgressBarStyle int style) {
        if (style < 0 || style > 1) {
    ...
    public void setTextFormatter(@Nullable ProgressTextFormatter textFormatter) {
        if (renderer != null) this.renderer.setTextFormatter(textFormatter);
    }
